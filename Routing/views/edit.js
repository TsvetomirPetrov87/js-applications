...
// make, model and etc are boolean values for the class
const editTemplate = (item, onSubmit, make, model, year, description, price, img) => html`
        ...
        <div class="row space-top">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <!--in this i how to verify the class-->
                    <input class=${'form-control' + (make ? ' is-valid' : ' is-invalid')} id="new-make"
                           type="text" name="make" value="${item.make}">
                </div>
                <div class="form-group has-success">
                    <label class="form-control-label" for="new-model">Model</label>
                    <!--in this i how to verify the class-->
                    <input class=${'form-control' + (model ? ' is-valid' : ' is-invalid')} id="new-model"
                           type="text" name="model" value="${item.model}">
                </div>
                <div class="form-group has-danger">
                    <label class="form-control-label" for="new-year">Year</label>
                    <input class=${'form-control' + (year ? ' is-valid' : ' is-invalid')} id="new-year"
                           type="number" name="year" value="${item.year}">
                </div>
                <div class="form-group">
                    <label class="form-control-label" for="new-description">Description</label>
                    <input class=${'form-control' + (description ? ' is-valid' : ' is-invalid')}
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class=${'form-control' + (price ? ' is-valid' : ' is-invalid')} id="new-price"
                           type="number" name="price" value="${item.price}">
                </div>
                <div class="form-group">
                    <label class="form-control-label" for="new-image">Image</label>
                    <input class=${'form-control' + (img ? ' is-valid' : ' is-invalid')} id="new-image"
...
export async function editPage(context) {
    ...
    context.render(editTemplate(item, onSubmit, true, true, true, true, true, true));
    ...
    async function onSubmit(event) {
        ...
        if (isValid) {
            context.render(editTemplate(item, onSubmit, validate.make, validate.model, validate.year, validate.description,
